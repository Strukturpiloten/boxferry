...
impl RuleId {
    ...
    pub const fn definition(self) -> &'static DiagnosticRule {
        match self {
            ...
            Self::ComposeNativeError => &RULES[13],
            Self::ComposeNativeWarning => &RULES[14],
            Self::ComposeNativeNote => &RULES[15],
            Self::DockerDataInvalid => &RULES[16],
            Self::DockerConfigurationUnsupported => &RULES[17],
            Self::DockerVersionUnsupported => &RULES[18],
            Self::DockerRelationshipMissing => &RULES[19],
            Self::OrchestrationFailed => &RULES[20],
            Self::InputReadFailed => &RULES[21],
            Self::ComposeProjectRootInvalid => &RULES[22],
            Self::PodmanTargetSelectionInvalid => &RULES[23],
            Self::InterpolationInputInvalid => &RULES[24],
            Self::ComposeLoadFailed => &RULES[25],
            Self::ConversionFailed => &RULES[26],
            Self::QuadletParseFailed => &RULES[27],
            Self::OutputDirectoryNotEmpty => &RULES[28],
            Self::OutputPathInvalid => &RULES[29],
            Self::OutputWriteFailed => &RULES[30],
            Self::ReportWriteFailed => &RULES[31],
            Self::SupportBundleWriteFailed => &RULES[32],
            Self::PodmanDataInvalid => &RULES[33],
            Self::PodmanConfigurationUnsupported => &RULES[34],
            Self::PodmanVersionUnsupported => &RULES[35],
            Self::PodmanRelationshipMissing => &RULES[36],
            Self::QuadletTargetInvalid => &RULES[37],
            Self::QuadletOpenEndedTarget => &RULES[38],
            Self::QuadletOutputUnsupported => &RULES[39],
            Self::QuadletValueInvalid => &RULES[40],
            Self::QuadletGenerationFailed => &RULES[41],
            Self::QuadletCapabilityUnavailable => &RULES[42],
            Self::QuadletGroupingApproximation => &RULES[43],
            Self::QuadletDependencyUnsupported => &RULES[44],
            Self::QuadletRestartApproximation => &RULES[45],
            Self::QuadletEnvironmentFileApproximation => &RULES[46],
            Self::QuadletGroupingInvalid => &RULES[47],
            Self::QuadletDependencyInvalid => &RULES[48],
            Self::QuadletCapabilityDeprecated => &RULES[49],
            Self::QuadletSourceInvalid => &RULES[50],
            Self::QuadletModelInvalid => &RULES[51],
            Self::QuadletInputUnsupported => &RULES[52],
            Self::QuadletInputApproximation => &RULES[53],
            Self::QuadletNativeSyntax => &RULES[54],
            Self::QuadletNativeModel => &RULES[55],
            Self::QuadletNativeDocumentSet => &RULES[56],
            Self::QuadletNativeFailure => &RULES[57],
            Self::RuntimeReconstructionUncertain => &RULES[58],
            Self::RuntimeOverrideInferred => &RULES[59],
            Self::RuntimeComparisonIncomplete => &RULES[60],
            Self::RuntimeOwnershipUncertain => &RULES[61],
            Self::RuntimePodRelationshipIncomplete => &RULES[62],
            Self::RuntimeImageMissing => &RULES[63],
            Self::RuntimeModelInvalid => &RULES[64],
            Self::RuntimeGroupConflict => &RULES[65],
            Self::RuntimeLifecycleResolved => &RULES[66],
            Self::RuntimeManagedMetadata => &RULES[67],
        }
    }
}
