...
- [Install BoxFerry and run one conversion](getting-started/)
- [Choose a conversion route](guides/)
- [Understand loss policies and fix-first diagnostics](concepts/)

## Look up

- [CLI commands and options](reference/cli/)
- [Diagnostic rules](reference/diagnostics/)
