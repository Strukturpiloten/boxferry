...
- [Podman output](../convert/compose-to-podman/) writes an inert Podman deployment plan.
...
`--env` when the selected route needs resolved values. All output routes use the same imported
neutral application.
