...
| `crates/boxferry-podman`  | PodmanLens-to-neutral and neutral-to-Podman mappings |
...
`boxferry-podman` uses the released independent PodmanLens contract. Docker and Kubernetes adapter
crates remain forbidden until their independent Lens libraries exist and a reviewed integration
